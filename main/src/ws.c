...
void collect_statistics() {
    ...
    // char elf_sha256[65];  // SHA-256 хеш представлен в 64 символах плюс завершающий нуль
    // int sha_err = esp_app_get_elf_sha256(elf_sha256, sizeof(elf_sha256));
    ...
    // printf("Chip Model: %s, Cores: %d, Revision: %d\n", chip_info.model == CHIP_ESP32 ? "ESP32" : "Unknown", chip_info.cores, chip_info.revision);
